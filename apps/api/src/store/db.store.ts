...
export class DbStore {
  ...
  public initDefaultState() {
    ...
    this.products = [
      { id: 'prod-101', org_id: 'org-1', category_id: 'cat-101', category_name: 'Starters & Appetizers', name: 'Crispy Garlic Butter Wings', price: 12.50, cost_price: 4.20, sku: 'APP-WNG-01', is_available: true, recipe: [{ inventory_item_id: 'inv-101', inventory_item_name: 'Fresh Chicken Wings', qty_required: 0.35, unit: 'kg' }] },
      { id: 'prod-102', org_id: 'org-1', category_id: 'cat-101', category_name: 'Starters & Appetizers', name: 'Truffle Parmesan Fries', price: 9.00, cost_price: 2.10, sku: 'APP-FRS-02', is_available: true, recipe: [{ inventory_item_id: 'inv-102', inventory_item_name: 'Idaho Potatoes', qty_required: 0.25, unit: 'kg' }] },
      { id: 'prod-103', org_id: 'org-1', category_id: 'cat-102', category_name: 'Main Courses', name: 'Slow-Cooked Butter Chicken', price: 18.99, cost_price: 6.50, sku: 'MAIN-BCH-01', is_available: true, recipe: [{ inventory_item_id: 'inv-101', inventory_item_name: 'Fresh Chicken Wings', qty_required: 0.30, unit: 'kg' }] },
      { id: 'prod-104', org_id: 'org-1', category_id: 'cat-103', category_name: 'Wood-fired Pizza', name: 'Artisanal Margherita Supreme', price: 16.00, cost_price: 3.90, sku: 'PIZ-MAR-01', is_available: true, recipe: [] },
      { id: 'prod-201', org_id: 'org-2', category_id: 'cat-201', category_name: 'Antipasti', name: 'Bruschetta al Pomodoro & Basilico', price: 11.50, cost_price: 3.10, sku: 'GB-ANT-01', is_available: true, recipe: [{ inventory_item_id: 'inv-201', inventory_item_name: 'San Marzano Tomatoes', qty_required: 0.20, unit: 'kg' }] },
      { id: 'prod-202', org_id: 'org-2', category_id: 'cat-202', category_name: 'Handmade Pasta & Risotto', name: 'Handmade Truffle Potato Gnocchi', price: 22.00, cost_price: 7.40, sku: 'GB-PST-02', is_available: true, recipe: [{ inventory_item_id: 'inv-202', inventory_item_name: 'Black Truffle Butter', qty_required: 0.05, unit: 'kg' }] },
      { id: 'prod-203', org_id: 'org-2', category_id: 'cat-202', category_name: 'Handmade Pasta & Risotto', name: 'Penne alla Basilico Pesto', price: 19.50, cost_price: 5.80, sku: 'GB-PST-03', is_available: true, recipe: [] },
      { id: 'prod-301', org_id: 'org-3', category_id: 'cat-301', category_name: 'Smash Burgers', name: 'Double Black Angus Smash Burger', price: 15.99, cost_price: 5.20, sku: 'UBL-BRG-01', is_available: true, recipe: [{ inventory_item_id: 'inv-301', inventory_item_name: 'Angus Beef Patties', qty_required: 0.30, unit: 'kg' }] },
      { id: 'prod-302', org_id: 'org-3', category_id: 'cat-302', category_name: 'Craft Sides & Fries', name: 'Loaded Beer-Battered Onion Rings', price: 8.50, cost_price: 2.00, sku: 'UBL-SDE-02', is_available: true, recipe: [] }
    ];
